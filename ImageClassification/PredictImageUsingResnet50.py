...
# Create the model
def create_model():
    json_file = open('model_created/resnet50_bottleneck_features_train.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)
    # load weights into new model
    loaded_model.load_weights("model_created/resnet50_bottleneck_fc_model.h5")
